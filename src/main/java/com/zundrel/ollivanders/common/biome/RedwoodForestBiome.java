...
public class RedwoodForestBiome extends Biome {
    ...
    static final int GRASS_COLOR = 0x163816;
    static final int FOLIAGE_COLOR = 0x163816;
    ...
    public RedwoodForestBiome() {
        ...
        OllivandersDefaultBiomeFeatures.addRedwoodForestTrees(this);
